...
- `lexr-kernel-bundle.json`; and
- `lexr-kernel-build-provenance.json`.
...
```bash
provenance="$build_dir/lexr-kernel-build-provenance.json"
...
- `lexr-kernel-bundle.json`;
- `lexr-kernel-release-manifest.json`;
...
1. Review `lexr-kernel-release-manifest.json` and `RELEASE-NOTES.md`.
