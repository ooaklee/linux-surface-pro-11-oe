...
| [SP11 G6 K1a transport fork](https://github.com/ooaklee/SP11X1e-touchscreen/commit/1807d22a476360a05a5b4c865f5e8ad857ae5721) | Candidate commit `1807d22a476360a05a5b4c865f5e8ad857ae5721` on `lsp11-x-g6-hidraw-bridge-7.2-rc5`; [draft PR #1](https://github.com/ooaklee/SP11X1e-touchscreen/pull/1) | Bounded off-target classification of spontaneous `DATA` responses at the existing transport ingress | This K1a seam has synthetic, sanitizer, CI, and retained-v3-header compile evidence only. It retains no descriptor, publishes no HID child, logs no payload, sends no hardware command, implements no pen path, and does not complete P2.3 |
| [SP11 audio UCM revision](https://github.com/ooaklee/linux-surface-pro-11-oe/commit/695592192691348d39445198a90ebcc9383eaa94) | Tracked microphone-route commit `695592192691348d39445198a90ebcc9383eaa94` | Existing device-specific UCM evidence under the interim owner direction in [`LEGAL.md`](../LEGAL.md) | The recorded basis is upstream ALSA plus local hardware configuration, pending the final provenance audit. Preserve upstream terms, per-file attribution, and local derivation evidence; this commit alone is not proof that the audit is complete |
