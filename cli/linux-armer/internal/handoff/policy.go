...
type FirmwarePolicy struct {
	...
	SourceName string
	// SourceINF is the canonical original Windows INF basename authorised to
	// provide SourceName. Published oemN.inf aliases are not selection authority.
	SourceINF string
...
var firmwarePolicyTable = [...]FirmwarePolicy{
	...
	},
	{
		...
		SourceINF:   "surfacepro_ext_adsp8380.inf",
	...
	},
	{
		...
		SourceINF:   "qcnspmcdm_ext_cdsp8380.inf",
