...
| Pen | ✅ Working (bridge) | G6 HEAT transport bridge into the IPTS DFT pipeline: hover, clicks, contact. See [how-to-run-pen-via-iptsd-bridge](docs/how-to/how-to-run-pen-via-iptsd-bridge.md). Pressure level, barrel, eraser not yet decoded. |
